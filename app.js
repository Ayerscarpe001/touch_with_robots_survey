...
const I18N = {
  zh: {
    ...
    countryGreece:"希腊",
    countryOther:"其他",
    infoError:"请完整填写有效年龄、性别、所属国家或地区、职业、受教育程度和社交机器人接受度后继续。",
    intentTitle:"社交意图选择",
  ...
  en: {
    ...
    countryOther:"Other",
    infoError:"Please complete a valid age, gender, country or region, occupation, education level, and social robot acceptance rating before continuing.",
